...
import com.artplusplus.contpp.service.ProductoService;

import java.util.List;

@CrossOrigin(origins = "http://localhost:3000")
@RestController // This means that this class is a Controller
@RequestMapping(path="/api/producto") // This means URL's start with / (after Application path)
public class ProductoController {
    ...
    @GetMapping(path="/")
    public @ResponseBody List<Producto> all() {
