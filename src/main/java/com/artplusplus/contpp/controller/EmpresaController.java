...
import com.artplusplus.contpp.service.EmpresaService;

import java.util.List;

@CrossOrigin(origins = "http://localhost:3000")
@RestController // This means that this class is a Controller
@RequestMapping(path="/api/empresa") // This means URL's start with / (after Application path)
public class EmpresaController {
    ...
    public ResponseEntity<Empresa> add(@RequestBody Empresa empresa) {
        ...
        Empresa obj = empresaService.save(empresa);
    ...
    @GetMapping(path="/")
    public @ResponseBody List<Empresa> all() {
