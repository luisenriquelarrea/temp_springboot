...
import com.artplusplus.contpp.service.FacturaService;

import java.util.List;

@CrossOrigin(origins = "http://localhost:3000")
@RestController // This means that this class is a Controller
@RequestMapping(path="/api/factura") // This means URL's start with / (after Application path)
public class FacturaController {
    ...
    @GetMapping(path="/")
    public @ResponseBody List<Factura> all() {
    ...
    public ResponseEntity<String> deleteById(@PathVariable String id) {
        Long facturaId = Long.parseLong(id);
