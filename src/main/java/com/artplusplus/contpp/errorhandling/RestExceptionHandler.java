...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
    public ResponseEntity<Object> handleBusinessViolation(final String error) {
        final ApiError apiError = new ApiError(HttpStatus.UNPROCESSABLE_ENTITY, error, error);
